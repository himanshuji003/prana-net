...
import {
  ...
  Activity, PieChart, Search, X, Zap, BrainCircuit
} from "lucide-react";
import { cn } from "@/lib/utils";
import { StatusPill } from "@/components/shared/StatusPill";
import { AnimatedCTA } from "@/components/shared/AnimatedCTA";
import { AICopilotPanel } from "@/components/ai-support";
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { name: "AI Copilot",         path: "/official/copilot",    icon: BrainCircuit },
...
export const OfficialDashboard = () => (
  <div className="h-screen bg-forest-primary font-sans pt-18 overflow-hidden">
    <Sidebar />
    {/* Content: full remaining height, scrollable for normal pages, copilot fills it */}
    <div className="ml-65 overflow-auto" style={{ height: "calc(100vh - 72px)" }}>
      <Routes>
        ...
        <Route path="/copilot"   element={<AICopilotPanel />} />
